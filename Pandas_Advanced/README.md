...
This repository focuses on expanding beginner's use of the Pandas Python package to optimize data manipulation and storage. Pandas is an easy-to-use, fast, and efficient library for storing and manipulating large datasets. 
...
3. Move to downloaded folder: ```cd Python_Package_Tutorials/Pandas_Advanced```
